                                                    ...
                                                    <div class="addForm container">
                                                        ...
                                                        <form action="{{ route('deals.update', $deal->id) }}" method="POST">
                                                                ...
                                                                <div class="HeaderCard">
                                                                    ...
                                                                    <div class="contents">
                                                                        <div class="title"><span
                                                                                id="cardCost">{{ $deal->cost ?? '0' }}</span> EGP
                                                                        </div>
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <div class="input-group-append">
                                                                                <span class="input-group-text"
                                                                                    onclick="populateInput('defaultname', '{{ $deal->name }}')">
                                                                ...
                                                                <div class="customer-data-entry">
                                                                    <div class="form-row">
                                                                        @foreach ($deal->deal_cards as $deal_card)
                                                                            ...
                                                                            <div class="form-group col-md-6">
                                                                                <label for="customerPhone{{ $deal_card->id }}">Card Phone</label>
                                                            ...
                                                            <button type="button" id="addCustomerButton"
                                                                class="btn btn-secondary">Add Another Card Data</button>
